...
XData FFDemux::Read()
{
    ...
    {
        d.isAudio = false;
       // XLOGE("demux time_base.num %d time_base.den %d",ic->streams[pkt->stream_index]->time_base.num,ic->streams[pkt->stream_index]->time_base.den);
