...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        double pos = (double) seekBar.getProgress() / 1;//(double) seekBar.getMax();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_play:
                //play("sdcard/2518.mp4");
                play("rtmp://192.168.60.182:1935/myapp/pc");
                //play("/sdcard/1080.mp4");
               // play("/sdcard/Download/周杰伦 - 晴天 (CCTV音乐频道).mp3");
                break;
        }
    }
